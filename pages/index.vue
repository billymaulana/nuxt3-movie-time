						...
						<div class="col-md-12">
							<div class="flex items-center justify-between">
								<div>
									...
									<h1 class="text-title">Discover Movies</h1>
								</div>
								<div class="flex items-center mt-[12px]">
									<NuxtLink class="btn btn-primary mr-5"> Popularity </NuxtLink>
									<NuxtLink class="btn btn-secondary"> Release Date </NuxtLink>
								</div>
							</div>
						</div>
						<div class="col-md-12">
							<div class="row pt-[40px]">
								<div
									v-for="(listDiscover, id) in discover?.results?.slice(0, 10)"
									:key="id"
