...
<template>
    <section v-if="movie" class="page-detail-section bg-white">
        <div class="container-fluid">
            <div v-if="movie" class="hero-section" 
                    ...
                    <div class="movie-detail">
                        ...
                        <div class="movie-info row flex items-center">
                            ...
                            <div class="col-6 col-md-auto col-lg-auto v-separator uppercase">
                                <div>
                                    <div>User Score</div>
                                    <div class="text-gray">{{ movie.vote_count }} Votes</div>
                                </div>
                            </div>
                            <div class="col-6 col-md-2 v-separator uppercase">
                                <div>Status</div>
                                <div class="text-gray">{{ movie.status }}</div>
                            </div>
                            <div class="col-6 col-md-2 v-separator uppercase">
                                <div>Language</div>
                                <div class="text-gray"> {{ movie.original_language }}</div>
                            </div>
                            <div class="col-6 col-md-2 v-separator uppercase">
                                <div>Budget</div>
                                <div class="text-gray">{{ moneyFormat(movie.budget) }}</div>
                            </div>
                            <div class="col-6 col-md uppercase">
                                <div>Production</div>
                                <div>
                                    <span class="text-gray" v-for="(production, id) in movie.production_companies" :key="id">
        ...
        <div class="container">
            <div class="row pt-5">
                <div class="empty-cols">&nbsp;</div>
                <div class="col-12 col-md-6 col-lg-8 col-xl-12">
                    <h2 class="f-14 text-red font-semibold lh-[18px] mb-3">Overview</h2>
                    <p> {{ movie?.overview}}</p>
                </div>
            </div>
        </div>
    ...
    <section class="reviews-section bg-white pb-10">
        <div class="container flex">
            <div class="row" v-if="reviews">
                <div class="col-md-12">
                    <h3 class="f-14 text-red font-semibold lh-[18px] mb-3">Review</h3>
                </div>
                <div class="col-md-6 flex-1" v-for="(review,id) in reviews.results.slice(0,2)" :key="id">
                    <div class="card-reviews">
                        <div class="flex justify-between">
                            <div class="flex items-center">
                                ...
                                <div class="font-semibold ml-2">{{review.author_details.username}}</div>
                            </div>
                            <div class="flex items-center">
                                <Icon name="ic:baseline-star" size="32" class="text-yellow mr-[5px]"/>
            ...
            <div v-else class="row">
                <div class="col-md-12">
                    <div class="font-semibold">Data Not Found</div>
                </div>
            </div>
        </div>
    </section>
